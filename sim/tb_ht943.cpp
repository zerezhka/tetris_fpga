...
int main(int argc, char** argv) {
    ...
    // The reference side (run_headless.py) dumps cpu.get_VRAM(), which
    // reports blank while halted — dump_vram's blank flag mirrors that
    // here too (previously this wrote the raw RAM; no fixture ends
    // halted, so no result changed).
