...
Статус: **в работе** (2026-07-06). Цель: `.pak` становится самодостаточным
картриджем — пользователь выбирает ОДИН файл, и грузится всё (программа,
звуковой ROM, лицо, профиль). Убирает нужду в mgl и в загрузке 3 файлов.
